		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url(web/images/product-1.jpg);">
									<div class="text text-center">
										<h2>Categorías</h2>
										<p>Seleccona la de tu preferencia</p>
										<p><a href="#" class="btn btn-primary">Ver más</a></p>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(web/images/product-1.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Categoria 1</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(web/images/product-2.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Categoria 2</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(web/images/product-3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Categoria 3</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(web/images/product-4.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Categoria 4</a></h2>
							</div>
						</div>
					</div>
				</div>
