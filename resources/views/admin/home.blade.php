			...
			<div class="card-body">
				<div class="d-flex no-block">
					<div class="m-r-20 align-self-center">
						...
						<img src="{{ '/admins/img/icon/staff.png'}}" alt="Tiendas" />
					</div>
					<div class="align-self-center">
						<h6 class="text-muted m-t-10 m-b-0">Tiendas</h6>
						<h2 class="m-t-0">{{ $stores }}</h2>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="feeds">
					...
					<li>
						<div class="bg-light-warning"><i class="ti-shopping-cart"></i></div> Registro y Control de Productos por Tienda.
					</li>
					<li>
						<div class="bg-light-danger"><i class="fa fa-home"></i></div> Visualización y Control de Tiendas.
					</li>
					<li>
						<div class="bg-light-inverse"><i class="fa fa-pencil"></i></div> Control de Pedidos y Ventas.
					</li>
				</ul>
			</div>
		</div>
