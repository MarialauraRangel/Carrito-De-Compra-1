						...
						<tbody>
							...
							<tr>
								...
								<td class="d-flex">
									...
									<button class="btn btn-danger btn-circle btn-sm" onclick="deleteGallery('{{ $gallery->slug }}')"><i class="fa fa-trash"></i></button>
								</td>
							</tr>
							@endforeach
						</tbody>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">¿Estás seguro de que quieres eliminar esta galería?</h5>
