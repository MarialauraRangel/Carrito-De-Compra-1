...
function deleteUser(slug) {
    $("#deleteUser").modal();
    $('#formDeleteUser').attr('action', '/sistema/usuarios/' + slug);
}

function deleteCategory(slug) {
    $("#deleteCategory").modal();
    $('#formDeleteCategory').attr('action', '/sistema/categorias/' + slug);
}

function deleteStore(slug) {
    $("#deleteStore").modal();
    $('#formDeleteStore').attr('action', '/sistema/tiendas/' + slug);
}

function deleteProduct(slug) {
    $("#deleteProduct").modal();
    $('#formDeleteProduct').attr('action', '/sistema/productos/' + slug);
}