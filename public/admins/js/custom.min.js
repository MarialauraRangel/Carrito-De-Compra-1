...
function deactiveUser(slug) {
    $("#deactiveUser").modal();
    $('#formDeactiveUser').attr('action', '/usuarios/desactivar/' + slug);
}
...
function confirmUsers(slug) {
    $("#confirmUsers").modal();
    $('#formConfirmUsers').attr('action', '/ventas/cajero-repartidor/' + slug);
}

function confirmState(slug) {
    $("#confirmState").modal();
    $('#formConfirmState').attr('action', '/ventas/estado/' + slug);
}

function confirmTime(slug) {
    $("#confirmTime").modal();
    $('#formConfirmTime').attr('action', '/ventas/tiempo/' + slug);
}
