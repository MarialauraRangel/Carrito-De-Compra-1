...
$(".sidebartoggler").on("click", function() {
    if (!$('.dark-logo[alt="icono"]').hasClass("logo-min")) {
        $('.dark-logo[alt="icono"]').addClass('logo-min');
        $('.dark-logo[alt="icono"]').attr('width', '60');
    } else {
        $('.dark-logo[alt="icono"]').removeClass('logo-min');
        $('.dark-logo[alt="icono"]').attr('width', '100');
    }
});
