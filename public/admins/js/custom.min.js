...
function deleteGallery(slug) {
    $("#deleteGallery").modal();
    $('#formDeleteGallery').attr('action', '/maesma/galeria/eliminar/' + slug);
}

function deletePage(slug) {
    $("#deletePage").modal();
    $('#formDeletePage').attr('action', '/maesma/paginas/eliminar/' + slug);
}

function deleteService(slug) {
    $("#deleteService").modal();
    $('#formDeleteService').attr('action', '/maesma/servicios/eliminar/' + slug);
}

function deleteSlider(slug) {
    $("#deleteSlider").modal();
    $('#formDeleteSlider').attr('action', '/maesma/sliders/eliminar/' + slug);
}
